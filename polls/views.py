...
class IndexView(generic.ListView):
    ...
    def get_queryset(self):
        ...
        # OBJECTIVE: Return the last 5 published questions excluding questions expected to be displayed in the future
        # return Question.objects.filter(pub_date__lte=timezone.now()).order_by("-publication_date")[:5]
